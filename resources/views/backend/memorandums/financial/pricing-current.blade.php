                    ...
                    <div class="basics-section">
                        <div class="row">
                            <div class="col-sm-8 clarfix title-col">
                                <h2>Pricing - Current</h2>
                            </div>
                            <div class="col-sm-6 m-t-30"></div>
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <form action="{{route('update.financial.pricing-current',$memorandum->id)}}" method="post"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <a href="{{ route('load.financial.income-expenses', $memorandum->id) }}"
                                ...
                                <div class="col-sm-6">
                                    <div class="image-container">
                                        <img src="{{ asset('memorandums/pricing-current.jpg') }}" class="img-responsive">
                                    </div>
                                </div>
                            </div>
                        </div>
