                ...
                <div class="form-section">
                    <div class="basics-section">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <form action="{{route('update.unit-mix',$rec->id)}}" method="post"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="number_of_units" class="form-control" placeholder="Number of Units" value="{{$rec->number_of_units}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label class="label-small">Unit Type <em>*</em></label>
                                                <input type="text" name="unit_type" class="form-control" placeholder="Unit Type" value="{{$rec->unit_type}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label class="label-small">Square Feet <em>*</em></label>
                                                <input type="text" name="sq_feet" class="form-control currency-mask" placeholder="Square Feet" value="{{$rec->sq_feet}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label class="label-small">Current Rent Min <em>*</em></label>
                                                <input type="text" name="current_rent_min" class="form-control currency-mask" placeholder="Current Rent Min" value="{{$rec->current_rent_min}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label class="label-small">Current Rent Max <em>*</em></label>
                                                <input type="text" name="current_rent_max" class="form-control currency-mask" placeholder="Current Rent Max" value="{{$rec->current_rent_max}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label class="label-small">Rent Per Square Feet <em>*</em></label>
                                                <input type="text" name="rent_per_sf" class="form-control" placeholder="Rent Per Square Feet" value="{{$rec->rent_per_sf}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label class="label-small">Monthly Income <em>*</em></label>
                                                <input type="text" name="monthly_income" class="form-control currency-mask" placeholder="Monthly Income" value="{{$rec->monthly_income}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label class="label-small">Proforma Rent Min <em>*</em></label>
                                                <input type="text" name="proforma_rent_min" class="form-control currency-mask" placeholder="Proforma Rent Min" value="{{$rec->proforma_rent_min}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label class="label-small">Proforma Rent Max <em>*</em></label>
                                                <input type="text" name="proforma_rent_max" class="form-control currency-mask" placeholder="Proforma Rent Max" value="{{$rec->proforma_rent_max}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label class="label-small">Proforma Rent Per Square Feet <em>*</em></label>
                                                <input type="text" name="rent_per_sf2" class="form-control" placeholder="Proforma Rent Per Square Feet" value="{{$rec->rent_per_sf2}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label class="label-small">Proforma Monthly Income <em>*</em></label>
                                                <input type="text" name="monthly_income2" class="form-control currency-mask" placeholder="Monthly Income" value="{{$rec->monthly_income2}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label class="label-small">Non Confirming? <em>*</em></label>
                                                <input type="checkbox" name="isNC" @if($rec->isNC == 1) checked @endif value="1" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
