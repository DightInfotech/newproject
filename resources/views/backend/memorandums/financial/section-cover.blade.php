                    ...
                    <div class="basics-section">
                        <div class="row">
                            <div class="col-sm-8 clarfix title-col">
                                <h3>Pricing and Financial Analysis Cover Page Image</h3>
                            </div>
                            <div class="col-sm-6 m-t-30"></div>
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <form action="{{route('update.financial.cover.page',$memorandum->id)}}" method="post"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <img @if(isset($rec->cover_page_1)) style="display: block;" @else style="display:none;" @endif id="img-1" src="{{isset($rec->cover_page_1) ? Storage::disk('s3')->url('assets/'.$rec->cover_page_1) : ''}}" alt="cover page photo" width="200" height="200" />
                                                <span class="inputs-note">Image must be upload of dimensions 1440 * 900 </span>
                                            </div>

                                        </div>
                                        <div class="hidden-inputs">
                                            <input type="hidden" name="cover_page_1" id="hidden-field-1" value="{{isset($rec->cover_page_1) ? $rec->cover_page_1 : ''}}">
                                            <input type="hidden" id="tmp1" value="">
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <a href="{{ route('load.confidentiality.member.page', $memorandum->id) }}"
                                ...
                                <div class="col-sm-6">
                                    <div class="image-container">
                                        <img src="{{ asset('memorandums/Page-4.jpg') }}" class="img-responsive">
                                    </div>
                                </div>
                            </div>
                        </div>
