                ...
                <div class="form-section">
                    <div class="basics-section">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <form action="{{route('update.market-comparable.graphs',$memorandum->id)}}" method="post"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div id="containerGRM" style = "width: 550px; height: 400px; margin: 0 auto">
                                                </div>
    ...
    <script language = "JavaScript">
        ...
        function drawGRMChart() {
            ...
            var options = {
                ...
                gridlineColor: '#fff',
                vAxis: {
                    ticks: [{v:0.00, f:'0.00'},{v:2.00, f:'2.00'},{v:4.00, f:'4.00'},{v:6.00, f:'6.00'},{v:8.00, f:'8.00'},{v:10.00, f:'10.00'},{v:12.00, f:'12.00'}]
                }
