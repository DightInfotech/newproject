                    ...
                    <div class="basics-section">
                        <div class="row">
                            <div class="col-sm-8 clarfix title-col">
                                <h3>Edit Market Comparable Property</h3>
                            </div>
                            <div class="col-sm-12 m-t-30"></div>
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <form action="{{route('market-comparable.update', $rec->id)}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" placeholder="Property Name" value="{{ $rec->name }}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="label-small">Address </label>
                                                <input type="text" name="address" class="form-control" placeholder="Address" value="{{ $rec->address }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="label-small">On Market Date <em>*</em></label>
                                                <input type="date" name="on_market_date" class="form-control" placeholder="Market Date" value="{{ $rec->on_market_date }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="label-small">Year Built In </label>
                                                <input type="text" name="year_built" class="form-control" placeholder="Year Built" value="{{$rec->year_built }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="sale_price" class="form-control currency-mask" placeholder="Sale Price" value="{{ $rec->sale_price }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="label-small">Price/SF </label>
                                                <input type="text" name="price_per_sf" class="form-control currency-mask" placeholder="Price Per Square Feet" value="{{ $rec->price_per_sf }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="label-small"> CAP Rate </label>
                                                <input type="text" name="cap_rate" class="form-control currency-mask" placeholder="CAP Rate" value="{{ $rec->cap_rate }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="label-small">GRM </label>
                                                <input type="text" name="grm" class="form-control currency-mask" placeholder="GRM" value="{{ $rec->grm }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="label-small"> Notes </label>
                                                <textarea name="notes" class="form-control" placeholder="Enter Property Notes" cols="10" rows="10">{{ $rec->notes }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <img id="img-1" src="{{Storage::disk('s3')->url('assets/'.$rec->image)}}" alt="Property Image" width="200" height="200" />
                                                <span class="inputs-note">Image must be upload of dimensions 450 * 250 </span>
                                            </div>
                                            <div class="hidden-inputs">
                                                <input type="hidden" name="image" id="hidden-field-1" value="{{$rec->image}}">
                                        ...
                                        <div id="sale-div" style="width: 100%;float: left;">
                                            ...
                                            <div id="content-dup" class="row">
                                                @if($rec->units)
                                                    @php $units = json_decode($rec->units) @endphp
