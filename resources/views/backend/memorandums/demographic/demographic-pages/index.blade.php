                ...
                <div class="form-section">
                    <div class="basics-section">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <a  class="addnew-btn" href="{{route('create.demographic-pages',$memorandum->id)}}">Create new page</a>
                                    <div class="job-item-details">
                                    @if(!empty($demographic_pages))
                                        @foreach($demographic_pages as $rec)
                                            <!-- item -->
                                                <div class="single-job-item">
                                                    <div class="top-row">
                                                        <div class="col-left">
                                                            <h5><a href="{{ route('edit.demographic-pages', $rec->id) }}">{{ $rec->title }}</a>
                                                            <br>
                                                                <span>@if($rec->template == '1C'){{'1 Image Template'}}
                                                                      @elseif($rec->template == '2P'){{'2 Images Template'}}
                                                                      @endif
                                                                </span></h5>
                                                        </div>
                                                        <div class="col-right">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <ul class="dropdown-menu">
                                                                            <li><a href="{{route('edit.demographic-pages', $rec->id) }}">Edit</a></li>
                                                                            <form method="post" action="{{route('delete.demographic-pages',$rec->id)}}" id="delete_{{$rec->id}}">
                                                                                {!! csrf_field() !!}
                                                                                {!! method_field('DELETE') !!}
                                    ...
                                    @if($demographic_pages->count() > 0)
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <a href="{{ route('load.demographic.section.cover', $memorandum->id) }}"
                                                       class="btn btn-danger" style="margin-left: 15px;">BACK</a>
                                                    <a href="{{ route('load.market-comparable.section.cover', $memorandum->id) }}" name="submit"
