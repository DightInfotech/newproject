    ...
    <div class="row">
        <div class="col-sm-12">
            <ul class="andmin-breadcrumb visible-xs visible-sm m-b-30">
                <li><a href="#">Create Demographic Memorandum</a></li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="basics-section">
                        <div class="row">
                            <div class="col-sm-8 clarfix title-col">
                                <h3>Demographic Analysis Cover Page Image</h3>
                            </div>
                            <div class="col-sm-6 m-t-30"></div>
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <form action="{{route('update.demographic.section.cover',$memorandum->id)}}" method="post"
                                ...
                                <div class="col-sm-6">
                                    <div class="image-container">
                                        <img src="{{ asset('memorandums/Page-36.jpg') }}" class="img-responsive">
                                    </div>
                                </div>
                            </div>
                        </div>
