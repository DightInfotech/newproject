                ...
                <div class="form-section">
                    <div class="basics-section">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <form action="{{route('update.gallery-pages',$rec->id)}}" method="post"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <h3>@if($rec->template == '2L') {{'Two Landscape Images Template'}}
                                                    @elseif($rec->template == '2P') {{'Two Portrait Images Template'}}
                                                    @else
                                                        {{'Six Images Template'}}
                                                    @endif</h3>
                                                {{--<select name="template" class="form-control" onchange="return templateSelected(this.value);">
                                                    <option value="">Select Template</option>
                                                    <option @if($rec->template == '2L') selected @endif value="2L">Two Landscape Images</option>
                                                    <option @if($rec->template == '2P') selected @endif value="2P">Two Portrait Images</option>
                                                    <option @if($rec->template == '6I') selected @endif value="6I">Six Images</option>
                                                </select>--}}
                                            </div>
                                        </div>
