                    ...
                    <div class="basics-section">
                        <div class="row">
                            <div class="col-sm-8 clarfix title-col">
                                <h3>Add Recent Sale Property</h3>
                            </div>
                            <div class="col-sm-12 m-t-30"></div>
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <form action="{{route('recent-sales.store')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="closing_date" class="form-control" placeholder="Closing Date" value="{{ old('closing_date') }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="cap_rate" class="form-control" placeholder="CAP Rate" value="{{ old('cap_rate') }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="label-small">GRM </label>
                                                <input type="text" name="grm" class="form-control" placeholder="GRM" value="{{ old('grm') }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
