    ...
    <div class="row">
        <div class="col-sm-12">
            <ul class="andmin-breadcrumb visible-xs visible-sm m-b-30">
                <li><a href="#">Recent Sale Graphs</a></li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="basics-section">
                        <div class="row">
                            <div class="col-sm-8 clarfix title-col">
                                <h3>Recent Sale Graphs</h3>
                            </div>
                            <div class="col-sm-6 m-t-30"></div>
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <a  class="addnew-btn" href="{{route('recent-sales.graphs.create',$memorandum->id)}}">Create new graph</a>
                                        ...
                                        @foreach($graphs as $rec)
                                            <!-- item -->
                                                <div class="single-job-item">
                                                    <div class="top-row">
                                                        <div class="col-left">
                                                            <h5><a href="{{ route('recent-sales.graphs.edit', $rec->id) }}">{{ $rec->graph_title }}</a></h5>
                                                        </div>
                                                        <div class="col-right">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <ul class="dropdown-menu">
                                                                            <li><a href="{{route('recent-sales.graphs.edit', $rec->id) }}">Edit</a></li>
                                                                            <form method="post" action="{{route('recent-sales.graphs.destroy',$rec->id)}}" id="delete_{{$rec->id}}">
                                                                                {!! csrf_field() !!}
                                                                                {!! method_field('DELETE') !!}
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <a href="{{ route('load.recent-sales.section.cover', $memorandum->id) }}"
                                                       class="btn btn-danger" style="margin-left: 15px;">BACK</a>
                                                    <a href="{{ route('load.recent-sales.map',$memorandum->id) }}" name="submit"
