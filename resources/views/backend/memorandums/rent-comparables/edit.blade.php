                ...
                <div class="form-section">
                    <div class="basics-section">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <form action="{{route('rent-comparable.update', $rent->id)}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" placeholder="Property Name" value="{{ $rent->name }}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="label-small">Address </label>
                                                <input type="text" name="address" class="form-control" placeholder="Address" value="{{ $rent->address }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="label-small">Occupancy <em>*</em></label>
                                                <input type="text" name="occupancy" class="form-control" placeholder="Occupancy" value="{{ $rent->occupancy }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="label-small">Year Built In </label>
                                                <input type="text" name="year_built" class="form-control" placeholder="Year Built" value="{{$rent->year_built }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="notes" class="form-control" placeholder="Enter Property Notes" cols="10" rows="10">{{ $rent->notes }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <img id="img-1" src="{{Storage::disk('s3')->url('assets/'.$rent->image)}}" alt="Property Image" width="200" height="200" />
                                                <span class="inputs-note">Image must be upload of dimensions 450 * 250 </span>
                                            </div>
                                            <div class="hidden-inputs">
                                                <input type="hidden" name="image" id="hidden-field-1" value="{{$rent->image}}">
                                        ...
                                        <div id="sale-div" style="width: 100%;float: left;">
                                            ...
                                            <div id="content-dup" class="row">
                                                <div class="row">
                                                @if($rent->units)
                                                    @php $units = json_decode($rent->units) @endphp
                                                    @foreach($units as $unit)
                                                        @foreach($unit as $key => $values)
                                                            <div id="type_div_{{$loop->parent->iteration}}" class="col-sm-3 form-group">
                                                                ...
                                                                <input type="text" id="type{{$loop->parent->iteration}}" name="unit_types[]" class="form-control" value="{{$key}}" />
                                                            </div>
                                                            @foreach($values as $ent)
                                                                @if($loop->index == 0)
                                                                    <div id="numb_div_{{$loop->parent->parent->iteration}}" class="col-sm-3 form-group">
                                                                        <label>Enter No of Units*</label>
                                                                        <input type="text" id="numb{{$loop->parent->parent->iteration}}" name="unit_numbers[]" class="form-control" value="{{$ent}}" />
                                                                    </div>
                                                                @endif
                                                                @if($loop->index == 1)
                                                                    <div id="sq_div_{{$loop->parent->parent->iteration}}" class="col-sm-3 form-group">
                                                                        <label>Enter SquareFeet*</label>
                                                                        <input type="text" id="sq{{$loop->parent->parent->iteration}}" name="unit_sqfts[]" class="form-control currency-mask" value="{{$ent}}" />
                                                                    </div>
                                                                @endif
                                                                @if($loop->index == 2)
                                                                    <div id="rent_div_{{$loop->parent->parent->iteration}}" class="col-sm-3 form-group">
                                                                        <label>Enter Rent*</label>
                                                                        <input type="text" id="rent{{$loop->parent->parent->iteration}}" name="unit_rents[]" class="form-control currency-mask" value="{{$ent}}" />
                                                                    </div>
                                                                @endif
                                                            @endforeach
                                                        @endforeach
