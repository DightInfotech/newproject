                    ...
                    <div class="basics-section">
                        <div class="row">
                            <div class="col-sm-8 clarfix title-col">
                                <h3>Rent Comparable Map</h3>
                            </div>
                            <div class="col-sm-6 m-t-30"></div>
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <form action="{{route('update.rent-comparables.map',$memorandum->id)}}" method="post"
                                ...
                                <div class="col-sm-6">
                                    <div class="image-container">
                                        <img src="{{ asset('memorandums/Page-31.jpg') }}" class="img-responsive">
                                    </div>
                                </div>
                            </div>
                        </div>
