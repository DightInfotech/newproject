                    ...
                    <div class="basics-section">
                        <div class="row">
                            <div class="col-sm-8 clarfix title-col">
                                <h3>Rent Comparable Graphs</h3>
                            </div>
                            <div class="col-sm-6 m-t-30"></div>
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <a  class="addnew-btn" href="{{route('rent-comparables.graphs.create',$memorandum->id)}}">Create new graph</a>
                                        ...
                                        @foreach($graphs as $rec)
                                            <!-- item -->
                                                <div class="single-job-item">
                                                    <div class="top-row">
                                                        <div class="col-left">
                                                            <h5><a href="{{ route('rent-comparables.graphs.edit', $rec->id) }}">{{ $rec->graph_title }}</a></h5>
                                                        </div>
                                                        <div class="col-right">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <ul class="dropdown-menu">
                                                                            <li><a href="{{route('rent-comparables.graphs.edit', $rec->id) }}">Edit</a></li>
                                                                            <form method="post" action="{{route('rent-comparables.graphs.destroy',$rec->id)}}" id="delete_{{$rec->id}}">
                                                                                {!! csrf_field() !!}
                                                                                {!! method_field('DELETE') !!}
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <a href="{{ route('load.rent-comparables.section.cover', $memorandum->id) }}"
                                                       class="btn btn-danger" style="margin-left: 15px;">BACK</a>
                                                    <a href="{{ route('load.rent-comparables.map',$memorandum->id) }}" name="submit"
