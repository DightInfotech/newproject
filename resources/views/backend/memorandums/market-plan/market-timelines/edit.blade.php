                ...
                <div class="form-section">
                    <div class="basics-section">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <form action="{{route('update.market-plan.timeline.pages',$rec->id)}}" method="post"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control" placeholder="Enter Page Title Here"   value="{{(isset($rec) && $rec->title) ? $rec->title : ''}}"/>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label class="label-small">Column 1 Content <em>*</em></label>
                                                <textarea name="column1" class="form-control js-wysiwyg">{{(isset($rec) && $rec->column1) ? $rec->column1 : ''}}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label class="label-small">Column 2 Content <em>*</em></label>
                                                <textarea name="column2" class="form-control js-wysiwyg">{{(isset($rec) && $rec->column2) ? $rec->column2 : ''}}</textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
