    ...
    <div class="row">
        <div class="col-sm-12">
            <ul class="andmin-breadcrumb visible-xs visible-sm m-b-30">
                <li><a href="#">Create Market Plan</a></li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="basics-section">
                        <div class="row">
                            <div class="col-sm-8 clarfix title-col">
                                <h3>Market Plan Cover Page Image</h3>
                            </div>
                            <div class="col-sm-6 m-t-30"></div>
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <form action="{{route('update.market-plan.section.cover',$memorandum->id)}}" method="post"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <img @if(isset($rec->section_cover)) style="display: block;" @else style="display:none;" @endif id="img-1" src="{{isset($rec->section_cover) ? Storage::disk('s3')->url('assets/'.$rec->section_cover) : ''}}" alt="cover page photo" width="200" height="200" />
                                ...
                                <div class="col-sm-6">
                                    <div class="image-container">
                                        <img src="{{ asset('memorandums/Page-53.jpg') }}" class="img-responsive">
                                    </div>
                                </div>
                            </div>
                        </div>
