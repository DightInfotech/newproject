<div class="page w-100 padding-zero">
	...
	<div class="main" style="padding: 20px 50px 0 50px;">
		<div class="container-content">
			<div class="row">
				<div style="width: 100%;float: left;"><h3>Recent Sales</h3></div>

				@if(!empty($recent_sales))
					@if($j == 1)
						<div data-mh="recent-sales" style="width: 30%; float: left; margin-right: 3%;">
							<div class="sales-item-box">
								...
								<div class="box-header">
									...
									<p>{!! $memorandum->address.' '.$memorandum->city.', '.$memorandum->state.' '.$memorandum->zip !!}</p>
								</div>
								...
								<div class="house-info">
									<table style="width: 100%;" >
										...
										<tr><td>CAP Rate:</td><td>@if(preg_match('/[A-Za-z]/', $pf->cap_rate_current)) {{$pf->cap_rate_current}} @else {!! number_format(cleanString($pf->cap_rate_current),2,'.',',') !!}% @endif</td></tr>
					...
					@foreach($recent_sales as $sale)
						<div style="width: 30%; margin-right: 3%;  @if($loop->iteration%3 == 0) float: right; @else float: left;  @endif" >
							<div class="sales-item-box">
								<div class="sales-item-image">
									<div class="image-caption"><table><tbody><tr><td>Close of Escrow</td><td>{!! date('m-d-Y',strtotime($sale->closing_date)) !!}</td></tr></tbody></table></div>
								...
								<div class="house-info">
									<table style="width: 100%;" >
										...
										<tr><td>CAP Rate:</td><td>@if(preg_match('/[A-Za-z]/', $sale->cap_rate)) {{$sale->cap_rate}} @else {!! number_format(cleanString($sale->cap_rate),2,'.',',') !!}% @endif</td></tr>
