<div class="page w-100 padding-zero">
	<div class="div-header header-height dot-bg" style="background-image: url({{base_path('public/pdf-assets/images/v-dot.jpg')}});">
	 ...
	 <div class="main page-24-bg page-4" style="background: url('{{Storage::disk('s3')->url('assets/'.$rcf->section_cover)}}')no-repeat center center;
         ...
         <h2 class="title-absolute">Rent Comparables</h2>
     </div>
</div>
