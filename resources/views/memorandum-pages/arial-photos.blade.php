		...
		<div class="flex-height flex-box">
			<div class="div-block">
				<div class="container-fluid">
					<h3>Arial Photos</h3>
					<div class="row">
						<div style="width: 47%; float: left;margin-left: 3%;"><img style="height: 700px" src="{{Storage::disk('s3')->url('assets/'.$pd->arial_image1)}}" alt="img"/></div>
						<div style="width: 47%; float: right; margin-left: 3%;"><img style="height: 700px" src="{{Storage::disk('s3')->url('assets/'.$pd->arial_image2)}}" alt="img"/></div>
					</div>
				</div>
			</div>
		</div>
