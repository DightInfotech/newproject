			...
			<div class="row">
				...
				<div style="width: 50%; float: left; margin-top: 50px;">
					<div class="d-flex flex-height  flex-column">
						...
						<div class="chart-box mt-auto">
							<img src="{{base_path('storage/app/public/graph-images/'.$mcf->avg_price_sf)}}" alt="img"/>
						</div>
					</div>
				</div>
				<div style="width: 47%; float: right; margin-top: 50px;">
					<div class="d-flex flex-height  flex-column">
						...
						<div class="chart-box mt-auto">
							<img src="{{base_path('storage/app/public/graph-images/'.$mcf->avg_price_unit)}}" alt="img"/>
						</div>
					</div>
				</div>
			</div>
