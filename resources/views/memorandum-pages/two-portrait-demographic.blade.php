	...
	<div class="main" style="padding: 50px 50px 0 50px;">
		<div class="container-content">
			<div class="row text-center">
				@if(!empty($demographic_images))
					@foreach($demographic_images as $image)
				<div style="width: 47%; float:left; margin-left:3%;position: relative;"><img style="height: 700px;" src="{{Storage::disk('s3')->url('assets/'.$image)}}" alt="image"></div>
					@endforeach
				@endif
			</div>
		</div>
