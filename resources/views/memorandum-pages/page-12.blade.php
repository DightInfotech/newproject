<div class="page w-100 padding-zero">
	...
	<div class="main page-4-bg page-4" style="background: url('{{Storage::disk('s3')->url('assets/'.$pd->cover_page_1)}}')no-repeat center center;
		...
		<h2 class="title-absolute">Property Description</h2>
	</div>
</div>
