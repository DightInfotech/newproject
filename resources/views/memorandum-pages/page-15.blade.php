		...
		<h3>Investment Highlights</h3>
			<div class="row text-content">
				<div style="width: 66%;float: left;">
					<img style="width: 97%; height: 340px;" src="{{Storage::disk('s3')->url('assets/'.$pd->highlights_image3)}}" alt="img" />
					<img style="width: 97%; height: 340px; margin-top: 20px;" src="{{Storage::disk('s3')->url('assets/'.$pd->highlights_image4)}}" alt="img" />
				</div>
				<div style="width: 30%;float: right;" class="list-circle">
					{!! $pd->invest_highlights2 !!}
				</div>
