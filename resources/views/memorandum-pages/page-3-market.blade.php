	 ...
	 <div class="center-content">
		 <div class="center-inner">
			 <table cellpadding="0" cellspacing="0">
				 ...
				 <tr>
					 <td class="first-td"><span>On Market</span></td>
					 <td align="right"><strong>{{$market_comp_section_number}}</strong></td>
				 </tr>
				 <tr>
				 ...
				 <tr>
					 <td class="first-td"><span>Marketing Plan</span></td>
					 <td align="right"><strong>{{$market_plan_section_number}}</strong></td>
				 </tr>
				 </tbody></table>
		 </div>
	 </div>
