...
class CreateRentComparableGraphs extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rent_comparable_graphs', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('rent_comparable_graphs');
    }
}
